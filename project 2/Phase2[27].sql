...
create table Route (
    ...
    leg_1 char(50) not null,
    distance_1 decimal(11, 2) not null,
    stop_1 char(3) not null,
    leg_2 char(50),
    distance_2 decimal(11, 2),
    stop_2 char(3),
    leg_3 char(50),
    distance_3 decimal(11, 2),
    stop_3 char(3),
	primary key (routeID)
) ENGINE=InnoDB;
...
('circle_east_coast', 'ATL', 'leg_4', 600, 'ORD', 'leg_20', 600, 'DCA', 'leg_7', 600, 'ATL'),
('circle_west_coast', 'LAX', 'leg_18', 1200, 'DFW', 'leg_10', 800, 'ORD', 'leg_22', 800, 'LAX'),
('eastbound_north_milk_run', 'SEA', 'leg_24', 1800, 'ORD', 'leg_20', 600, 'DCA', 'leg_8', 200, 'JFK'),
('eastbound_north_nonstop', 'SEA', 'leg_23', 2400, 'JFK', NULL, NULL, NULL, NULL, NULL, NULL),
('eastbound_south_milk_run', 'LAX', 'leg_18', 1200, 'DFW', 'leg_9', 800, 'ATL', 'leg_1', 600, 'IAD'),
('hub_xchg_southeast', 'ORD', 'leg_25', 600, 'ATL', 'leg_4', 600, 'ORD', NULL, NULL, NULL),
('hub_xchg_southwest', 'ORD', 'leg_22', 800, 'LAX', 'leg_26', 800, 'ORD', NULL, NULL, NULL),
('local_texas', 'IAH', 'leg_12', 200, 'DAL', 'leg_6', 200, 'HOU', NULL, NULL, NULL),
('northbound_east_coast', 'ATL', 'leg_3', 800, 'JFK', NULL, NULL, NULL, NULL, NULL, NULL),
('northbound_west_coast', 'LAX', 'leg_19', 1000, 'SEA', NULL, NULL, NULL, NULL, NULL, NULL),
('southbound_midwest', 'ORD', 'leg_21', 800, 'DFW', NULL, NULL, NULL, NULL, NULL, NULL),
('westbound_north_milk_run', 'JFK', 'leg_16', 800, 'ORD', 'leg_22', 800, 'LAX', 'leg_19', 1000, 'SEA'),
('westbound_north_nonstop', 'JFK', 'leg_17', 2400, 'SEA', NULL, NULL, NULL, NULL, NULL, NULL),
('westbound_south_nonstop', 'ATL', 'leg_27', 1600, 'LAX', NULL, NULL, NULL, NULL, NULL, NULL);
